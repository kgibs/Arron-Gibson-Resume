...
### Work History:
* [BMO - Bank of Montreal](http://bmo.com) - **Web Developer**
	* ```January 2017 - Present```
	* Responsible for helping to maintain and improve the flagship website [bmo.com](http://bmo.com)
	* Helping to lead the team into new territory with a flat file generating CMS using technologies such as:
		* **Vagrant**, **NodeJS**, **JSON**, **Webpack** and **HARP**
...
* Highly Proficient in:
	...
	* <acronym title="Cascading StyleSheets">CSS</acronym>
		* **SASS**
		* **Stylus**
		* Frameworks such as **Bootstrap**, **Compass** and **Foundation**
	* Javascript
		* **jQuery** expert and teacher
		* **es2015+** expert and coach
		* **NodeJS**
		* Familiarity with **Webpack** and **Babel** for using newer language constructs while targeting current browsers.
	...
	* WordPress
		...
		* In Depth familiarity with the plugins:
			* Gravity Forms
			* Advanced Custom Fields
			* Yoast SEO
			* WooCommerce
			* Timber
		* and a belief that other than those above you should almost always code the rest yourself.
